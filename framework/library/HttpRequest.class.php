...
class HttpRequest
{
    ...
    public static function isLocal() {
        $ip = getServerString('REMOTE_ADDR');
        return ($ip == '127.0.0.1');
    }
    ...
    public static function getRemotePort() {  
        return getServerString('REMOTE_PORT');
    }
    ...
    public static function getScheme() {  
        return getServerString('REQUEST_SCHEME');
    }
    ...
    public static function isHttp() {  
        return getServerString('REQUEST_SCHEME') == 'http';
    }
    ...
    public static function isHttps() {  
        return getServerString('REQUEST_SCHEME') == 'https';
    }
    ...
    public static function getHost() {  
        return getServerString('HTTP_HOST');
    }
    ...
    public static function getQueryString() {  
        return getServerString('QUERY_STRING');
    }
    ...
    public static function getUri() {  
        return getServerString('REQUEST_URI');
    }
    ...
    public static function getUserAgent() {  
        return getServerString('HTTP_USER_AGENT');
    }
    ...
    public static function getMethod() {  
        return getServerString('REQUEST_METHOD');
    }
    ...
    public static function getCookies() {  
        return getServerString('HTTP_COOKIE');
    }
    ...
    public static function getRoot() {  
        return getServerString('DOCUMENT_ROOT');
    }
    ...
    public static function getScript() {  
        return getServerString('SCRIPT_FILENAME');
    }
    ...
    public static function getTime() {
        return getServerString('REQUEST_TIME');
    }
